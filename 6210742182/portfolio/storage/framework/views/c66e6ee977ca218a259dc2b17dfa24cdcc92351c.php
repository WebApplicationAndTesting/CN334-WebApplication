...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <style>
            ...
            .ml-custom{margin-left:10rem} */
            /* .mi-auto{}} */
            /* .-mt-px{margin-top:-1px}.max-w-6xl{max-width:72rem}.max-w-myset{max-width:40rem}
            ...
            .pt-c{padding-top:0.5px}
            .top-0{top:0}.right-0{right:0}
            .bottom{bottom: 4.5rem;}
            .px-center{margin:auto}
            .py-center{margin:auto}
            ...
            .white{--text-opacity:1;color:rgba(255,255,255,var(--text-opacity))}
            .underline{text-decoration:underline}.antialiased{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
            .w-5{width:1.25rem}.w-8{width:2rem}.w-auto{width:auto}.grid-cols-1{grid-template-columns:repeat(1,minmax(0,1fr))}@media (min-width:640px){.sm\:rounded-lg{border-radius:.5rem}.sm\:block{display:block}.sm\:items-center{align-items:center}.sm\:justify-start{justify-content:flex-start}.sm\:justify-between{justify-content:space-between}.sm\:h-20{height:5rem}.sm\:ml-0{margin-left:0}.sm\:px-6{padding-left:1rem;padding-right:1rem}.sm\:pt-0{padding-top:0}.sm\:text-left{text-align:left}.sm\:text-right{text-align:right}}@media (min-width:768px){.md\:border-t-0{border-top-width:0}.md\:border-l{border-left-width:1px}.md\:grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (min-width:1024px){.lg\:px-8{padding-left:2rem;padding-right:2rem}}@media (prefers-color-scheme:dark){.dark\:bg-gray-800{--bg-opacity:1;background-color:#2d3748;background-color:rgba(45,55,72,var(--bg-opacity))}.dark\:bg-gray-900{--bg-opacity:1;background-color:#1a202c;background-color:rgba(26,32,44,var(--bg-opacity))}.dark\:border-gray-700{--border-opacity:1;border-color:#4a5568;border-color:rgba(74,85,104,var(--border-opacity))}.dark\:text-white{--text-opacity:1;color:#fff;color:rgba(255,255,255,var(--text-opacity))}.dark\:text-gray-400{--text-opacity:1;color:#cbd5e0;color:rgba(203,213,224,var(--text-opacity))}} */
        ...
        <div class="relative flex justify-center min-h-screen bg-mycolor sm:items-center sm:pt-0">
            ...
            <!-- <?php if(Route::has('login')): ?>
                <div class="hidden fixed bottom px-center py-center sm:block">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-sp poppins">Login</a>

                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-custom text-sp poppins">Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?> -->
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="ml-12 fix-position" style="width:80%; margin-left: auto; margin-right: auto;">
                ...
                <div class="flex justify-center setsize py-center">
                    <!-- <img src="<?php echo e(URL('images/icon2.png')); ?>" alt=""> -->
                </div>
            </div>
...
<?php /**PATH /Users/sundress/Documents/CN334-WebApplication/6210742182/portfolio/resources/views/welcome.blade.php ENDPATH**/ ?>