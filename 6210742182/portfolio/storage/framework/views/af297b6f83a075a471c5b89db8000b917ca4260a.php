...
<?php endif; ?>
                ...
                <li class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex font-dome1 fontstyle-dome1">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('dashboard')).'','active' => request()->routeIs('dashboard'),'class' => 'fontcolor-dome1']]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('dashboard')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard')),'class' => 'fontcolor-dome1']); ?>
                        <?php echo e(__("let's see, what I have to do")); ?>
...
<?php /**PATH /Users/sundress/Documents/CN334-WebApplication/newapp/resources/views/navigation-dropdown.blade.php ENDPATH**/ ?>