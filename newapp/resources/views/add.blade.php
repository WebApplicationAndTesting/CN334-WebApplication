            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <form method="POST" action="/task">
                    ...
                    <div class="form-group">
                        ACTION
                        <textarea name="description" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"  placeholder='Action'></textarea>  
                    ...
                    <div class="form-group">
                        TIME
                        <textarea name="time" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"  placeholder='Time'></textarea>  
                        @if ($errors->has('time'))
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn-dome1 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded font-dome1 fontcolor-dome1">ยืนยัน</button>
                    </div>
                    {{ csrf_field() }}
