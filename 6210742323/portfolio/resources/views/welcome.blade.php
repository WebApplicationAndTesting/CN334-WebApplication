...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <style>
            ...
            .text {font-family: 'Poppins', sans-serif;	text-transform: uppercase;background: linear-gradient(to right, #a0aec0 5%, #4a5568 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent}
        ...
        <div class="relative flex justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
            ...
            <!-- @if (Route::has('login'))
                <div class="hidden fixed bottom px-center py-center sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sp poppins">Login</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-custom text-sp poppins">Register</a>
                        @endif
                    @endif
                </div>
            @endif -->
